"""
Django settings for anote_rest project.
...
SECRET_KEY = 'oq7!@yz%bdhw2$@9@#7v@wv6uwu5(ht@n9cwsb!-pai-!cxuje'
...
WSGI_APPLICATION = 'anote_rest.wsgi.application'
